...
if($r_id == "") 
{
	// 
 	// 	Invalid Login
	//
	die("I could not find that profile in the database.");
}
...
echo "If you wish to update the profile, make the changes below and
	then click on 'Update'.
	<P>

	<form method=POST action=useredit-2.php?id=$user_id>
	...
	<tr>
		<th align=right>Administrative Access:
		<td><select name=admin_access>
			<option ";
